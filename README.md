...
A aplicação utiliza HATEOAS para melhorar a navegabilidade e autodescoberta de recursos na API.
...
- **Login de Teste**: Para testar a aplicação, utilize as credenciais de login abaixo:
...
4. **Acesse a Aplicação**:
   - Local: [http://localhost:8080/clientes](http://localhost:8080/clientes)
   - Nuvem: [ProspAI na Azure](https://prospai.azurewebsites.net)
